# Generated by Django 4.1 on 2022-08-04 18:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PersonResponsible', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='dashboard.personresponsible', verbose_name='Person Responsible')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue_date', models.DateTimeField(blank=True, default=datetime.datetime(2022, 8, 4, 19, 50), null=True)),
