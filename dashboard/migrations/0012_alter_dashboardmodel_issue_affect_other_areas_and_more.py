...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dashboard', '0011_alter_dashboardmodel_issue_date_alter_image_image'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='dashboardmodel',
            name='issue_date',
            field=models.DateTimeField(blank=True, default=datetime.datetime(2022, 8, 16, 10, 59), null=True),
        ),
        migrations.AlterField(
            model_name='dashboardmodel',
            name='issue_solved',
