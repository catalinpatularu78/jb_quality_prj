...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dashboard', '0014_alter_dashboardmodel_issue_affect_other_areas_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='dashboardmodel',
            name='issue_date',
            field=models.DateTimeField(blank=True, default=datetime.datetime(2022, 8, 10, 15, 40), null=True),
        ),
        migrations.AlterField(
            model_name='dashboardmodel',
            name='issue_solved',
